          ...
          <div class="section new">
            <div class="row">
              <?php foreach ($terbaru as $terbaru) : ?>
                <div class="col-lg-12">
                  <?= Html::img(is_file(Yii::getAlias("@webroot/common/dokumen/$terbaru->image")) ? Yii::$app->request->hostInfo . "/common/dokumen/$terbaru->image" : Yii::$app->request->hostInfo . '/frontend/assets/img/default.jpg', ['class' => 'rounded']); ?>
                  <?=
