...
/* @var $model backend\models\InformasiHukum */
...
<div class="box box-primary box-solid">
    <div class="box-header with-border">
        <b>Form Tambah Data Informasi Hukum</b>

    </div>

    <div class="box-body">
        <?= $form->field($model, 'jenis')->dropDownList(
            \yii\helpers\ArrayHelper::map(\backend\models\JenisInformasiHukum::find()->asArray()->all(), 'id', 'name'),
            [
        ...
        <?= $form->field($model, 'tanggal')->widget(
            ...
            [
                ...
                'widgetOptions' => [
                    'options' => ['placeholder' => 'tulis tanggal Informasi Hukum'],
                    'pluginOptions' => [
        ...
        $form->field($model, 'isi')->widget(Summernote::class, [
            'options' => ['placeholder' => 'masukkan isi Informasi Hukum...']
        ]);
        ?>
