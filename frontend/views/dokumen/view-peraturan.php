                        ...
                        <ul class="widget-list">
                            ...
                            if (!empty($lampiran)) {
                                foreach ($lampiran as  $data) {
                                    ...
                                    echo '<a href="/common/dokumen/' . $data->dokumen_lampiran . '" class="btn btn-secondary btn-sm mb-2 btn-hover-primary" target="_blank" title="lihat file">' . $data['dokumen_lampiran'] . '</a>';
                                }
                            }
                            if (!empty($model->abstrak)) {
                                ...
                                echo '<a href="/common/dokumen/' . $model->abstrak . '" class="btn btn-secondary btn-sm mb-2 btn-hover-primary" target="_blank" title="lihat file">' . $model->abstrak . '</a>';
                            }
                            ?>
