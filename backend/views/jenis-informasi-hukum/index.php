...
/* @var $searchModel backend\models\JenisInformasiHukumSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Jenis Informasi Hukum';
...
<div class="box-body table-responsive no-padding">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-book"></i> Data ' . 'Jenis Informasi Hukum' . '</h3>',
        ],
        'toolbar' =>  [
