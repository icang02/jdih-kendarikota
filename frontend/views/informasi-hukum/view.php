                    ...
                    <div class="section new">
                        <div class="row">
                            <?php foreach ($terbaru as $terbaru) : ?>
                                <div class="col-lg-12">
                                    <?= Html::img('@web/common/dokumen/' . $terbaru->image, ['class' => 'rounded']); ?>
                                    <!-- <h5><?= $terbaru->judul ?></h5> -->
                                    <?=
                                    Html::a(implode(" ", array_slice(explode(" ", $terbaru->judul), 0, 4)) . '....', ['informasi-hukum/view', 'style' => 'color:black;', 'id' => $terbaru->id]);
                                    ?>
                                    <div class="detail">
