...
/* @var $searchModel backend\models\search\Informasi HukumSearch */
...
<div class="box-body table-responsive no-padding">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-book"></i> Data ' . 'Informasi Hukum' . '</h3>',
        ],
        'toolbar' =>  [
