        ...
        <div class="header-text display-table z-index-1 width-100">
            <div class="display-table-cell">
                ...
                <p class="font-size18 xs-font-size16 text-white text-center" data-aos-delay="200" data-aos="fade-up">
                    SELAMAT DATANG DI SITUS RESMId
                </p>
            ...
            <?php foreach ($pengumuman  as $data) : ?>
                <div class="col-lg-12 sm-margin-30px-bottom">
                    <div class="card row h-100">
                        <?= Html::img($data->image ? '@web/common/dokumen/' . $data->image : 'frontend/assets/img/default.jpg', ['class' => 'card-img-top col-lg-2']); ?>
                        <div class="card-body padding-30px-all col-lg-10">
                            ...
                            <h5 class="card-title font-size22 font-weight-500 magin-20px-bottom">
                                <a href="blog-details.html" class="text-extra-dark-gray"><?= Html::a(implode(" ", array_slice(explode(" ", $data->judul), 0, 3)) . ' .....', ['pengumuman/view', 'id' => $data->id]) ?></a>
                            </h5>
                            <div class="detail">
                ...
                <?php foreach ($berita as $data) : ?>
                    <div class="col-lg-4 sm-margin-30px-bottom ">
                        <div class="card h-100">
                            <?= Html::a(Html::img($data->image ? "@web/common/dokumen/$data->image" : 'frontend/assets/img/default.jpg', ['class' => 'card-img-top rounded']), ['berita/view', 'id' => $data->id]); ?>
