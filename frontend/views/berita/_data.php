...
<div class="col-lg-4 col-md-6 col-sm-12 margin-30px-bottom">
    <div class="card border-0 shadow h-100">
        <a href="#">
            <?= Html::a(Html::img($model->image != "" || $model->image != null ? "@web/common/dokumen/$model->image" : '/frontend/assets/img/default.jpg', ['class' => 'card-img-top rounded']), ['berita/view', 'id' => $model->id]); ?>
        </a>
