                            ...
                            <div class="post-img col-lg-4 mb-4">
                                ...
                                <div class="mt-4">
                                    ...
                                    if (!empty($model->dokumen)) {
                                        echo  Html::a('<i class="fa-solid fa-file-arrow-down"></i> &nbsp; Download Dokumen', ['/common/dokumen/' . $model->dokumen], ['class' => 'btn btn-primary', 'target' => '_blank', 'title' => 'lihat file']);
                                    }
                                    ?>
                                </div>
                            </div>
                    ...
                    <div class="widget search my-0">
                        ...
                        <div class="input-group my-0">
                            ...
                            $form = ActiveForm::begin([
                                'action' =>  Url::to(['/pengumuman/index']),
                                'method' => 'get',
                                'options' => [
                                    'data-pjax' => 1
                                ],
                    ...
                    <div class="section new">
                        <div class="row">
                            <?php foreach ($terbaru as $terbaru) : ?>
                                <div class="col-lg-12">
                                    <?= Html::img($terbaru->image ? "@web/common/dokumen/$terbaru->image" : '/frontend/assets/img/default.jpg', ['class' => 'rounded']); ?>
                                    <!-- <h5><?= $terbaru->judul ?></h5> -->
                                    <?=
                                    Html::a(implode(" ", array_slice(explode(" ", $terbaru->judul), 0, 4)) . '....', ['pengumuman/view', 'style' => 'color:black;', 'id' => $terbaru->id]);
                                    ?>
                                    <div class="detail">
